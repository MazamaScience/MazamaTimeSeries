...
test_that("character date formats work", {
  ...
  expect_identical(
    c(start_PDT, end_PDT),
    range( sts_filterDatetime(example_sts, 20180802, 20180803)$data$datetime )
  )
  ...
  expect_identical(
    c(start_PDT, end_PDT),
    range( sts_filterDatetime(example_sts, "2018-08-02", 20180803)$data$datetime )
  )
  
  expect_identical(
    c(start_PDT, end_PDT),
    range( sts_filterDatetime(example_sts, "2018-08-02 00", 20180803)$data$datetime )
  )
  
  expect_identical(
    c(start_PDT, end_PDT),
    range( sts_filterDatetime(example_sts, "2018-08-02 00:00:00", 20180803)$data$datetime )
  )
...
test_that("character date formats work with timezones", {
  ...
  expect_identical(
    c(start_PDT, end_PDT),
    range( sts_filterDatetime(example_sts, 20180802, 20180803, timezone = "America/Los_Angeles")$data$datetime )
  )
  
  expect_identical(
    c(start_MDT, end_MDT),
    range( sts_filterDatetime(example_sts, 20180802, 20180803, timezone = "America/Denver")$data$datetime )
  )
  
  expect_identical(
    c(start_EDT, end_EDT),
    range( sts_filterDatetime(example_sts, 20180802, 20180803, timezone = "America/New_York")$data$datetime )
  )
  
  expect_identical(
    c(start_UTC, end_UTC),
    range( sts_filterDatetime(example_sts, 20180802, 20180803, timezone = "UTC")$data$datetime )
  )
...
test_that("POSIXct date formats work", {
  ...
  expect_identical(
    c(start_HST, end_HST),
    range( sts_filterDatetime(example_sts, start_Hawaii, end_Hawaii)$data$datetime )
  )
  
  expect_identical(
    c(start_PDT, end_PDT),
    range( sts_filterDatetime(example_sts, start_LA, end_LA)$data$datetime )
  )
  
  expect_identical(
    c(start_MDT, end_MDT),
    range( sts_filterDatetime(example_sts, start_Denver, end_Denver)$data$datetime )
  )
  
  expect_identical(
    c(start_EDT, end_EDT),
    range( sts_filterDatetime(example_sts, start_NYC, end_NYC)$data$datetime )
  )
...
test_that("POSIXct date formats work with timezones", {
  ...
  expect_identical(
    c(start_PDT, end_PDT),
    range( sts_filterDatetime(example_sts, start_LA, end_LA, timezone = "America/Los_Angeles")$data$datetime )
  )
  
  expect_identical(
    c(start_MDT, end_MDT),
    range( sts_filterDatetime(example_sts, start_Denver, end_Denver, timezone = "America/Denver")$data$datetime )
  )
  
  expect_identical(
    c(start_EDT, end_EDT),
    range( sts_filterDatetime(example_sts, start_NYC, end_NYC, timezone = "America/New_York")$data$datetime )
  )
